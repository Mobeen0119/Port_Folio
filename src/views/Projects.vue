<template>
  <div class="min-h-screen bg-[#030305] text-slate-100 overflow-x-hidden font-sans selection:bg-blue-500/30">
    <div class="fixed inset-0 -z-10 overflow-hidden">
      <div class="absolute inset-0 bg-[radial-linear(circle_at_50%_-20%,#1e293b,transparent)]"></div>
      <div class="absolute top-0 left-1/4 w-75 md:w-125 h-75 md:h-125 bg-blue-600/10 blur-[100px] md:blur-[120px] rounded-full animate-pulse"></div>
      <div class="absolute inset-0 bg-[url('https://grainy-linears.vercel.app/noise.svg')] opacity-20"></div>
    </div>
    ...
    <section class="container mx-auto px-4 md:px-6 py-12 md:py-24">
      <div class="mb-12 md:mb-20 space-y-4">
        ...
        <h1 class="text-5xl md:text-8xl font-extrabold tracking-tighter italic uppercase">
          <span class="bg-clip-text text-transparent bg-linear-to-b from-white to-slate-500">
            Projects
          </span>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
        <div v-for="(project, index) in displayProjects" :key="project.id"
          ...
          <div class="relative h-48 md:h-64 w-full overflow-hidden rounded-t-3xl border-b border-white/5">
            ...
            <div class="absolute inset-0 bg-linear-to-t from-[#030305] via-transparent to-transparent"></div>
          ...
          <div class="p-6 md:p-8 flex flex-col flex-grow">
            ...
            <p class="text-slate-400 text-xs md:text-sm leading-relaxed mb-6 grow line-clamp-3 md:line-clamp-none">
              {{ project.description }}
            </p>
